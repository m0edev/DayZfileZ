...
{
	private void DayZInfectedCommandMove() {}
	private void ~DayZInfectedCommandMove() {}
...
{
	private void DayZInfectedCommandDeath() {}
	private void ~DayZInfectedCommandDeath() {}
}

class DayZInfectedCommandHit   extends AnimCommandBase
{
	private void DayZInfectedCommandHit() {}
	private void ~DayZInfectedCommandHit() {}
}

class DayZInfectedCommandAttack extends AnimCommandBase
{
	private void DayZInfectedCommandAttack() {}
	private void ~DayZInfectedCommandAttack() {}
...
{
	private void DayZInfectedCommandVault() {}
	private void ~DayZInfectedCommandVault() {}
...
{
	private void DayZInfectedCommandCrawl() {}
	private void ~DayZInfectedCommandCrawl() {}
}
