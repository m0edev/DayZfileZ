class OptionsMenuVideo extends ScriptedWidgetEventHandler
{
	...
	void OptionsMenuVideo( Widget parent, Widget details_root, GameOptions options, OptionsMenu menu )
	{
		...
		#ifdef PLATFORM_PS4
		m_Root.FindAnyWidget( "vsync_setting_option" ).SetUserID( AT_OPTIONS_FLIPMODE );
		#endif
	...
	void SetOptions( GameOptions options )
	{
		...
		#ifdef PLATFORM_PS4
		m_FlipModeOption				= ListOptionsAccess.Cast( m_Options.GetOptionByType( AT_OPTIONS_FLIPMODE ) );
		#endif
	...
	void FillTextMap()
	{
		...
		#ifdef PLATFORM_PS4
		m_TextMap.Insert( AT_OPTIONS_FLIPMODE, new Param2<string, string>( "#options_video_V-sync", "#options_video_V-sync_desc" ) );
		#endif
